...
import {
  LoginRequest,
  RegisterRequest,
  RegisterWebMasterRequest,
} from './dto/authentication.request';
...
export class AuthenticationController {
  ...
  @HttpCode(HttpStatus.CREATED)
  public registerWebMaster(
    @Body(ValidationPipe) registerWebMasterRequest: RegisterWebMasterRequest,
  ) {
    registerWebMasterRequest.role = Role.ADMINISTRATOR;
    return this.authenticationService.registerWebMaster(
      registerWebMasterRequest,
    );
  }
}
