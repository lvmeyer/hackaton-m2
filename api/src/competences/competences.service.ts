import {
  ...
  export class CompetencesService {
    ...
    async createCompetence(createCompetenceRequest: CreateCompetenceRequest): Promise<any> {
      try {
    ...
    async update(
      ...
      try {
        ...
        return await this.competencesRepository.update(uuid, updateCompetenceRequest);
      } catch (err) {
