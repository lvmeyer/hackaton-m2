...
export class MissionsController {
  ...
  async createMission(
    ...
    createMissionRequest.endMission = new Date(createMissionRequest.endMission);
    return await this.missionsService.createMission(createMissionRequest);
  }
  ...
  @AuthenticationRequired()
  @HttpCode(HttpStatus.OK)
  async findById(@Param('uuid', ParseUUIDPipe) uuid: string): Promise<Mission> {
