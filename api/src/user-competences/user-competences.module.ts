...
@Module({
  imports: [TypeOrmModule.forFeature([UserCompetences, Competence, User, Mission, Level, Badges])],
  controllers: [CompetencesController, UserCompetencesController],
  providers: [CompetencesService, UsersService, MissionsService, LevelsService, BadgesService, UserCompetencesService],
